            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h2 className="mb-4 text-4xl font-medium text-black ">
                  Grow your business <span className="">now</span>!
                </h2>
              ...
              <div>
                <a
                  href="#"
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-blue-700 bg-blue-700 px-6 py-3 leading-6 font-semibold text-white bg-blue-500"
                >
